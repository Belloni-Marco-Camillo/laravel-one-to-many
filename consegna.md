Esercizio di oggi, Laravel Boolpress nome repo: :puntare_a_destra:laravel-one-to-many
Cloniamo il progetto di ieri in una nuova repo e rifate ciò che abbiamo visto insieme stamattina.
Mettere in relazione Posts e Categorie.
Bonus:
fare le operazioni CRUD per la pagina admin delle categorie
...
Scaletta! se la copiate in un file .md e aprite la preview riuscite a seguirla meglio.
